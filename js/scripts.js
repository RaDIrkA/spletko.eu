...
$('footer').fadeIn('slow');$('#content').hide();$('.offer').hide();$('.zakajnas').show();$('.offer_nav').animate({top:'-50px'});$('body').animate({top:'+=170px'})}
...
$('footer').fadeOut('fast');$('#content').show();$('.zakajnas').hide();$('.offer_nav').animate({top:'+50px'});$('body').animate({top:'-=170px'})}
